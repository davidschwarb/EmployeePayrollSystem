...
public class PayrollSystem {
	...
	public void populateEmployees() {                //Runs a for loop to run employees[i].populateEmployee() for each employee
		...
		for (int i = 0; i < employees.length; i++) {
			...
			} while (!(choice.equalsIgnoreCase("H") || choice.equalsIgnoreCase("hourly")
				|| choice.equalsIgnoreCase("S") || choice.equalsIgnoreCase("salary")
				|| choice.equalsIgnoreCase("C") || choice.equalsIgnoreCase("commission")));

			if (choice.equalsIgnoreCase("H") || choice.equalsIgnoreCase("hourly")) {
				System.out.println("Hourly Chosen.");
				employees[i] = new HourlyEmployee();
			} else if (choice.equalsIgnoreCase("S") || choice.equalsIgnoreCase("salary")) {
				System.out.println("Salary Chosen.");
				employees[i] = new SalaryEmployee();
			} else if (choice.equalsIgnoreCase("C") || choice.equalsIgnoreCase("commission")) {
